...
CREATE TABLE IF NOT EXISTS continents (
  code    TEXT NOT NULL PRIMARY KEY UNIQUE,    -- 'Continent code',
  name    TEXT
  )  ;
...
CREATE TABLE IF NOT EXISTS countries (
  code           TEXT NOT NULL PRIMARY KEY UNIQUE,   -- 'Two-letter country code (ISO 3166-1 alpha-2)',
  name           TEXT NOT NULL  ,                    -- 'English country name',
  full_name      TEXT NOT NULL ,                     -- 'Full English country name',
  iso3           TEXT NOT NULL UNIQUE,               -- 'Three-letter country code (ISO 3166-1 alpha-3)',
  number         INTEGER NOT NULL UNIQUE ,           -- 'Three-digit country number (ISO 3166-1 numeric)',
